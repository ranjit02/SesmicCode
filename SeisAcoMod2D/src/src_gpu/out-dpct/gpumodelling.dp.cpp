 ...
 * nnx);*/
        ...
        */
        dpct::get_default_queue().submit([&](sycl::handler &cgh) {
            sycl::range<2> s_vx_range_ct1(Block_size1,
                                          Block_size2+3);
 ...
 * nnx);*/
        ...
        */
        dpct::get_default_queue().submit([&](sycl::handler &cgh) {
            sycl::range<2> s_vz_range_ct1(Block_size1+3,
                                          Block_size2);
 ...
 * nnx);*/
        ...
        */
        dpct::get_default_queue().submit([&](sycl::handler &cgh) {
            sycl::range<2> s_p_range_ct1(Block_size1,
                                         Block_size2+3);
 ...
 * nnx);*/
        ...
        */
        dpct::get_default_queue().submit([&](sycl::handler &cgh) {
            sycl::range<2> s_p_range_ct1(Block_size1+3,
                                         Block_size2);
